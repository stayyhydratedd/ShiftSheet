...
create table app_folder(
    ...
    title varchar not null,
    google_id varchar,
    users_folder_google_id varchar,
    user_data_spreadsheet_google_id varchar,
    user_details_sheet_google_id int,
    roots_folder_google_id varchar,
...
alter table app_settings add column app_folder_id int references app_folder(id);

insert into app_settings(id) values (1);
insert into app_folder(id, title) values (1, 'ShiftSheet');
